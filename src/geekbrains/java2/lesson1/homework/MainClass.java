...
public class MainClass {
    public static void main(String[] args) {
        ...
        Team t1 = new Team("Team 1", new Team.Sportsman[]{new Team().new Human("Vassiliy Alibabaevitch"),
                                                          new Team().new Cat("Dormidont"),
                                                          new Team().new Dog("Barboskin"),
                                                          new Team().new Horse("Anyuta")});//  Создаем первую команду
